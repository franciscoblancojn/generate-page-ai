...
require_once GPAI_DIR . 'src/templates/respond.php';
require_once GPAI_DIR . 'src/templates/tooltip.php';
require_once GPAI_DIR . 'src/templates/collapse.php';
...
require_once GPAI_DIR . 'src/templates/table_post_by_url.php';